...
impl ::protobuf::Message for SmartPermission {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "name",
                    |m: &SmartPermission| { &m.name },
                    |m: &mut SmartPermission| { &mut m.name },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "org_id",
                    |m: &SmartPermission| { &m.org_id },
                    |m: &mut SmartPermission| { &mut m.org_id },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "function",
                    |m: &SmartPermission| { &m.function },
                    |m: &mut SmartPermission| { &mut m.function },
                ));
                ::protobuf::reflect::MessageDescriptor::new::<SmartPermission>(
                    "SmartPermission",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static SmartPermission {
        static mut instance: ::protobuf::lazy::Lazy<SmartPermission> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const SmartPermission,
        };
        unsafe {
            instance.get(SmartPermission::new)
        }
    }
}

impl ::protobuf::Clear for SmartPermission {
    fn clear(&mut self) {
        self.clear_name();
        self.clear_org_id();
        self.clear_function();
...
impl ::std::fmt::Debug for SmartPermission {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for SmartPermission {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
pub struct SmartPermissionList {
    // message fields
    pub smart_permissions: ::protobuf::RepeatedField<SmartPermission>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl SmartPermissionList {
    pub fn new() -> SmartPermissionList {
        ::std::default::Default::default()
    }

    // repeated .SmartPermission smart_permissions = 1;

    pub fn clear_smart_permissions(&mut self) {
        self.smart_permissions.clear();
    }

    // Param is passed by value, moved
    pub fn set_smart_permissions(&mut self, v: ::protobuf::RepeatedField<SmartPermission>) {
        self.smart_permissions = v;
    }

    // Mutable pointer to the field.
    pub fn mut_smart_permissions(&mut self) -> &mut ::protobuf::RepeatedField<SmartPermission> {
        &mut self.smart_permissions
    }

    // Take field
    pub fn take_smart_permissions(&mut self) -> ::protobuf::RepeatedField<SmartPermission> {
        ::std::mem::replace(&mut self.smart_permissions, ::protobuf::RepeatedField::new())
    }
...
impl ::protobuf::Message for SmartPermissionList {
    fn is_initialized(&self) -> bool {
        for v in &self.smart_permissions {
            if !v.is_initialized() {
                return false;
            }
        };
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_repeated_message_into(wire_type, is, &mut self.smart_permissions)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        for value in &self.smart_permissions {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        };
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
    ...
    fn new() -> SmartPermissionList {
        SmartPermissionList::new()
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                let mut fields = ::std::vec::Vec::new();
                fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<SmartPermission>>(
                    "smart_permissions",
                    |m: &SmartPermissionList| { &m.smart_permissions },
                    |m: &mut SmartPermissionList| { &mut m.smart_permissions },
                ));
                ::protobuf::reflect::MessageDescriptor::new::<SmartPermissionList>(
                    "SmartPermissionList",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static SmartPermissionList {
        static mut instance: ::protobuf::lazy::Lazy<SmartPermissionList> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const SmartPermissionList,
        };
        unsafe {
            instance.get(SmartPermissionList::new)
        }
    }
}

impl ::protobuf::Clear for SmartPermissionList {
    fn clear(&mut self) {
        self.clear_smart_permissions();
        self.unknown_fields.clear();
    }
}

impl ::std::fmt::Debug for SmartPermissionList {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for SmartPermissionList {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x16smart_permission.proto\"\x97\x01\n\x05Agent\x12\x15\n\x06org_id\
    \x18\x01\x20\x01(\tR\x05orgId\x12\x1d\n\npublic_key\x18\x02\x20\x01(\tR\
    \tpublicKey\x12\x16\n\x06active\x18\x03\x20\x01(\x08R\x06active\x12\x14\
    \n\x05roles\x18\x04\x20\x03(\tR\x05roles\x12*\n\x08metadata\x18\x05\x20\
    \x03(\x0b2\x0e.KeyValueEntryR\x08metadata\"+\n\tAgentList\x12\x1e\n\x06a\
    gents\x18\x01\x20\x03(\x0b2\x06.AgentR\x06agents\"7\n\rKeyValueEntry\x12\
    \x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12\x14\n\x05value\x18\x02\x20\
    \x01(\tR\x05value\"S\n\x0cOrganization\x12\x15\n\x06org_id\x18\x01\x20\
    \x01(\tR\x05orgId\x12\x12\n\x04name\x18\x02\x20\x01(\tR\x04name\x12\x18\
    \n\x07address\x18\x03\x20\x01(\tR\x07address\"G\n\x10OrganizationList\
    \x123\n\rorganizations\x18\x01\x20\x03(\x0b2\r.OrganizationR\rorganizati\
    ons\"X\n\x0fSmartPermission\x12\x12\n\x04name\x18\x01\x20\x01(\tR\x04nam\
    e\x12\x15\n\x06org_id\x18\x02\x20\x01(\tR\x05orgId\x12\x1a\n\x08function\
    \x18\x03\x20\x01(\x0cR\x08function\"T\n\x13SmartPermissionList\x12=\n\
    \x11smart_permissions\x18\x01\x20\x03(\x0b2\x10.SmartPermissionR\x10smar\
    tPermissionsb\x06proto3\
";
